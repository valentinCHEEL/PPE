...
public class PanelInterventions extends PanelPrincipal implements ActionListener {
			...
			this.panelForm.add(new JLabel("numclient :"));
			...
			String entetes [] = {"numI", "dateAffectation ", " dateArrive "," dateFin "," etat "," libelleMateriel","matricule","numclient"};
		  ...
		  //remplir le type du client 
		    ...
		    this.tableInterventions.addMouseListener(new MouseListener() {
		        ...
		        if (e.getClickCount()>= 2) {
		        	...
		        	txtLibelleMateriel.setText(tableInterventions.getValueAt(numLigne,5).toString());
		        	txtMatricule.setText(tableInterventions.getValueAt(numLigne, 6).toString());
		        	txtnumClient.setText(tableInterventions.getValueAt(numLigne, 7).toString());
			...
			public Object [][] remplirDonnees (String filtre){
				...
				for (Intervention uneIntervention: lesInterventions) {
					...
					matrice [i][7] = uneIntervention.getnumClient();
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == this.btAnnuler) {
				...
				Intervention uneIntervention = new Intervention( dateAffectation, dateArrive , dateFin, etat, libelleMateriel, matricule, numclient);
				...
				Object ligne[]= {uneIntervention.getNumI(), dateAffectation, dateArrive , dateFin, etat, libelleMateriel, matricule, numclient};
				...
				Intervention uneIntervention = new Intervention(idLigne, dateAffectation, dateArrive , dateFin, etat, libelleMateriel, matricule, numclient);
				//modification de la base de données :
				Controleur.updateIntervention(uneIntervention);
				//modification de la table d'affichage
				Object ligne[] = {idLigne,  dateAffectation, dateArrive , dateFin, etat, libelleMateriel, matricule, numclient};
