...
public class PanelTechniciens extends PanelPrincipal implements ActionListener{
		...
		String entetes [] = {"matricule", "NomT", "PrenomT","disponibilite","tarifHoraire", "email"};
	  ...
	  //remplir le type du client 
	    ...
	    this.tableTechniciens.addMouseListener(new MouseListener() {
	        ...
	        if (e.getClickCount()>= 2) {
	        	...
	        	txtEmail.setText(tableTechniciens.getValueAt(numLigne,5).toString());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btAnnuler) {
			...
			Technicien unTechnicien = new Technicien (nomT, prenomT, disponibilite, tarifHoraire, email);
			...
			Object ligne[]= {unTechnicien.getMatricule(), nomT, prenomT, disponibilite, tarifHoraire, email};
			...
			Technicien unTechnicien = new Technicien(idLigne, nomT, prenomT, disponibilite, tarifHoraire, email);
			//modification de la base de données :
			Controleur.updateTechnicien(unTechnicien);
			//modification de la table d'affichage
			Object ligne[] = {idLigne, nomT, prenomT, disponibilite, tarifHoraire, email};
